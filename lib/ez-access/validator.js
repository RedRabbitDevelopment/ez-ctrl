...
(function() {
  var Q, exportObject, loadValidator, underscore, validate, validator;
  loadValidator = function(Q, _, validate) {
    var Validator, check;
  ...
  return exportObject(loadValidator(Q, underscore, validate));
})();
