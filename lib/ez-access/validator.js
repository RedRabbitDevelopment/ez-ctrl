...
(function() {
  ...
  loadValidator = function(exportObject, Q, _, EventEmitter, validate) {
    var Validator, check;
        ...
        try {
          ...
          if (!this.ValidationMethods[validator]) {
            ...
            if ((checker = check.apply(null, args))[validator]) {
              ...
              if (typeof Validator.trigger === "function") {
  ...
  if (!(typeof window !== "undefined" && window !== null ? window.define : void 0)) {
    return exportObject(loadValidator(exportObject, Q, underscore, EventEmitter, validate));
  } else {
    ...
    return window.define('Validator', ['exportObject', 'q', 'underscore', 'ez-event-emitter', 'validate'], loadValidator);
  }
})();
