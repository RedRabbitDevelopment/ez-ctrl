...
(function() {
  ...
  module.exports = FrontEnd = (function() {
    ...
    FrontEnd.prototype.registerRoutes = function(app, dirname) {
      var initPromise,
        _this = this;
      initPromise = dirname ? (this.controllerManager = new ControllerManager(), this.controllerManager.readdir(dirname)) : (this.controllerManager = ControllerManager, Q.when(true));
      return initPromise.then(function() {
        _this.controllerManager.registerRoutes(app);
        app.get('/js/lib/ez-routes.js', function(req, res) {
          if (!frontEndJS) {
            frontEndJS = this.getFrontEndMethods();
          }
