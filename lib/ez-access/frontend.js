...
(function() {
  ...
  module.exports = FrontEnd = (function() {
    ...
    FrontEnd.prototype.convertToFrontEnd = function(object) {
      ...
      output = "(function(generator) {	if(typeof module !== 'undefined' && module.exports) {		module.exports = generator(require('EZAccess'));	} else if (typeof define !== 'undefined' && define.amd) {		define(['ez-access'], generator);	} else {		window.EZRoutes = generator(window.EZAccess);	}})(function(EZAccess) {		";
      for (field in object) {
        value = object[field];
