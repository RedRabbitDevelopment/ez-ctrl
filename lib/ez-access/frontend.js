...
(function() {
  ...
  module.exports = FrontEnd = (function() {
    ...
    FrontEnd.prototype.getFrontEndMethods = function(hostname) {
      ...
      return this.convertToFrontEnd(EZAccess, hostname);
    };

    FrontEnd.prototype.convertToFrontEnd = function(object, hostname) {
