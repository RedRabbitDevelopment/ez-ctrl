...
(function() {
  ...
  module.exports = FrontEnd = (function() {
    ...
    FrontEnd.prototype.getFrontEndMethods = function(hostname, protocol) {
      ...
      return this.convertToFrontEnd(EZAccess, hostname, protocol);
    };

    FrontEnd.prototype.convertToFrontEnd = function(object, hostname, protocol) {
      var field, output, value;
      output = "(function(generator) { if(typeof module !== 'undefined' && module.exports) { module.exports = generator(require('ez-access'), require('lodash')); } else if (typeof define !== 'undefined' && define.amd) { define(['ez-access', 'lodash'], generator); } else { window.EZRoutes = generator(window.EZAccess, window._); } })(function(EZAccess, _) {";
      for (field in object) {
        value = object[field];
        output += ("EZAccess['" + field + "'] = _.extend({}, EZAccess, ") + this.convertToFrontEndRaw(value, 1);
        output += ");\n";
      }
      if (hostname) {
