...
(function() {
  (function(generator) {
    ...
    if ((typeof exports !== "undefined" && exports !== null) && module.exports) {
      Q = require('q');
      return module.exports = generator(Q);
    } else if ((typeof define !== "undefined" && define !== null) && define.amd) {
      return define(['q'], generator);
    } else {
      return window.EZAccess = generator(Q);
    }
  })(function(Q) {
    var EZAccess;
    return EZAccess = {
      ...
      eventualArray: function(promise) {
        ...
        promise.then(function(result) {
          ...
          for (i = _i = 0, _len = result.length; _i < _len; i = ++_i) {
            value = result[i];
            _results.push(shell.push(result[i]));
          }
          return _results;
        });
        return shell;
