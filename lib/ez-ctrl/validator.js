...
module.exports = Validator = {
  ...
  validateField: function(validation, field, value) {
    var promises, validator, validatorData, validators, _fn;
    ...
    if (validators) {
      _fn = function(value, validator, validatorData, field) {
        return promises.push(Validator.runValidate(value, validator, validatorData, field).then(function(result) {
          var deferred;
      ...
      for (validator in validators) {
        ...
        _fn(value, validator, validatorData, field);
      }
    }
    return Q.allSettled(promises).then(function(results) {
