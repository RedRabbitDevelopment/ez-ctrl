...
module.exports = Validator = {
  ...
  */
  ...
  validateField: function(validators, field, value) {
    var promises, validator, validatorData;
    promises = [];
    if (!value) {
      if (validators.required) {
        return this.runValidateAndGetReadableError(value, 'required', true, field).fail(function(error) {
          var deferred;
          deferred = Q.defer();
          deferred.reject([
            {
    ...
    if (validators) {
      for (validator in validators) {
        ...
        promises.push(this.runValidateAndGetReadableError(value, validator, validatorData, field));
      }
    }
    return Q.allSettled(promises).then(function(results) {
  ...
  */
  ...
  runValidateAndGetReadableError: function(value, validator, validatorData, field) {
    return Validator.runValidate(value, validator, validatorData, field).then(function(result) {
      var deferred;
