...
module.exports = BaseController = {
  ...
  extend: function(options) {
    ...
    NewController = function(routeDetails) {
      ...
      if (options.name) {
        BaseController.setBaseData.call(this, options.name);
      }
    };
    _.extend(NewController, this, options);
    middleware = middleware ? this.beforeEachMiddleware.concat(middleware) : this.beforeEachMiddleware.slice(0);
  ...
  getMiddleWare: function(routeDetails) {
    return this.beforeEachMiddleware.concat(routeDetails.middleware);
  },
...
BaseController.prototype = {
  handleRequest: function(req, res) {
    ...
    return Q.when().then(function() {
      ...
      var logicArguments;
      logicArguments = _this.extractLogicArguments(data);
  ...
  extractLogicArguments: function(data) {
    ...
    args = FuncDetails.extractArguments(this.logic);
    argData = [];
