...
module.exports = BaseController = {
  ...
  getRouteDetails: function(route) {
    var logic, m, method, pattern, remainingRoute, routeDetails, usesId, validation, _i, _len, _ref;
    usesId = false;
  ...
  registerRoute: function(app, routeDetails) {
    return app[routeDetails.method](routeDetails.pattern, this.handleRequest.bind(this, routeDetails));
  },
