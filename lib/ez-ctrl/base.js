...
(function() {
  var BaseController, Converter, FuncDetails, Q, UserError, Validator, inflection, _;
  ...
  BaseController.prototype = {
    ...
    validate: function(data) {
      return Validator.validate(this.validation, data, this.modelName).fail(function(error) {
        var e;
