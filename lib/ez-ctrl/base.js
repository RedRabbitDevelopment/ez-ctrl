...
(function() {
  var BaseController, Bluebird, Converter, Form, FuncDetails, UserError, Validator, inflection, util, _;
  ...
  module.exports = BaseController = {
    ...
    getRouteDetails: function(route) {
      var before, logic, m, method, middleware, pattern, remainingRoute, returnType, routeDetails, usesId, validation, _i, _len, _ref;
      usesId = false;
  ...
  BaseController.prototype = {
    ...
    handleForked: function() {
      return Bluebird.settle(this.forked).then((function(_this) {
