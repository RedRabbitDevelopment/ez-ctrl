...
(function() {
  var Bluebird, TestData, TestServer, assert, http, _;
  ...
  describe("Test Server", function() {
    ...
    return describe("special cases", function() {
      ...
      return describe("beforeEach", function() {
        it("should run base and user", function(done) {
          return makeRequest({
            method: "GET",
            path: '/users/1'
        ...
        it("should run base and async", function(done) {
          return makeRequest({
            method: "GET",
            path: '/async_users/1'
          }).then(function(data) {
        ...
        return it("should run on before too", function(done) {
          return makeRequest({
            method: "GET",
